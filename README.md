...
- Spalten ein-/ausklappbar: volle Breite bleibt erhalten, nur der
  Karten-Bereich schrumpft in der Höhe. Bleibt dabei als Drop-Ziel aktiv
  – Karten lassen sich also auch bei eingeklappter Spalte reinziehen.
  Zustand bleibt pro Browser gespeichert.
